...
class KatexView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    private var mTextColor: Int = android.R.color.white
    private var textColor: String = "#fff";
    ...
    fun setTextColorString(color: String){
        textColor = color;
    }
    ...
    private fun getHexColor(intColor: Int): String {
        val col: String = String.format("#%06X", 0xFFFFFF and intColor)
