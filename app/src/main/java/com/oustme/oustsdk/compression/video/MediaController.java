package com.oustme.oustsdk.compression.video;
...
public class MediaController {
    ...
    public boolean convertVideo(final String path) {
        try {
            ...
            int rotationValue = 90, originalWidth = 100, originalHeight = 100;
            if (rotation != null)
            ...
            File cacheFile = new File(OustSdkApplication.getContext().getFilesDir(), "compress.mp4");
            ...
            //inputFile.delete(); //Removing original file - So removing this line.
        } catch (Exception e) {
            e.printStackTrace();
