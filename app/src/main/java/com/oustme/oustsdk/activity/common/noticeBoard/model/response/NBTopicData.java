...
public class NBTopicData {
    ...
    private ArrayList<PostUpdateData> userPostUpdateData,postUpdateData;
    ...
    public ArrayList<PostUpdateData> getUserPostUpdateData() {
        return userPostUpdateData;
    }

    public void setUserPostUpdateData(ArrayList<PostUpdateData> userPostUpdateData) {
    ...
    public ArrayList<PostUpdateData> getPostUpdateData() {
    ...
    public void setPostUpdateData(ArrayList<PostUpdateData> postUpdateData) {
    ...
    public NBTopicData setExtraNBData(NBTopicData nbTopicData,Map<String, Object> lpMap){
        try {
            if (lpMap != null) {
