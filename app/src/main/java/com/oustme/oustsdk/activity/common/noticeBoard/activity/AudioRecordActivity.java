...
public class AudioRecordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            OustSdkTools.setLocale(AudioRecordActivity.this);
        }catch (Exception e){
            e.printStackTrace();
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (checkPermission()) {
                    AudioSavePathInDevice = OustSdkApplication.getContext().getFilesDir().getPath() + "/" + CreateRandomAudioFileName(5) + "AudioRecording.3gp";
                    MediaRecorderReady();
                    try {
