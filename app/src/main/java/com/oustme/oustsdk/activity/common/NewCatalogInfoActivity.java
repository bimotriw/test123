...
import com.oustme.oustsdk.room.DaoMapDataModel;
...
public class NewCatalogInfoActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
//        OustGATools.getInstance().reportPageViewToGoogle(NewCatalogInfoActivity.this,"Subscribe Catalog Popup");
            ...
            public void onDataChange(DataSnapshot student) {
                ...
                try {
                    if (null != student.getValue()) {
                        ...
                        if ((lpMap != null)) {
                            DTOMapDataModel realmMapDataModel = new DTOMapDataModel();
                            if (catalog_type.contains("COURSE")) {
                                realmMapDataModel.setId("COURSE"+catalog_id);
                                commonTools.getCourseCommonData(lpMap, commonLandingData);
                            } else {
                                realmMapDataModel.setId("ASSESSMENT"+catalog_id);
                                commonTools.getAssessmentCommonData(lpMap, commonLandingData);
                            }
                            String mapStr=gson.toJson(lpMap);
                            realmMapDataModel.setLandingDataMap(mapStr);
                            RoomHelper.addorUpdateMapDataModel(realmMapDataModel);
    ...
    private void setData(CommonLandingData commonLandingData) {
        ...
        catalog_title.setText("" + commonLandingData.getName());
        if (commonLandingData.getDescription() != null && !commonLandingData.getDescription().isEmpty())
            catalog_description.setText("" + commonLandingData.getDescription());
...
//        }
    ...
    private void hitServerToAddCatalog(final boolean startCourse) {
        try {
            ShowPopup.getInstance().showProgressBar(NewCatalogInfoActivity.this);
