...
public class NBMembersAdapter extends RecyclerView.Adapter<NBMembersAdapter.MyViewHolder> {
    private final String TAG = "NBTopicAdapter";
    List<NBMemberData> nbMemberDataList;
    ...
    private AdapterPostionNotifier adapterPostionNotifier;

    public NBMembersAdapter(Context context, List<NBMemberData> nbMemberDataList,AdapterPostionNotifier adapterPostionNotifier) {
        this.nbMemberDataList = nbMemberDataList;
        this.context = context;
        this.adapterPostionNotifier = adapterPostionNotifier;
    }

    public void notifyListChnage(List<NBMemberData> nbMemberDataList) {
        this.nbMemberDataList = nbMemberDataList;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.nb_members_item, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        try {
            ...
            NBMemberData nbMemberData = nbMemberDataList.get(position);
