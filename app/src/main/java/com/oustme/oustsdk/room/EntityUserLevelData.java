...
@Entity
 class EntityUserLevelData {
    ...
    @TypeConverters(TCUserCardData.class)
    private List<EntityUserCardData> userCardDataList;
    ...
    public List<EntityUserCardData> getUserCardDataList() {
        return userCardDataList;
    }

    public void setUserCardDataList(List<EntityUserCardData> userCardDataList) {
    ...
    public boolean isIslastCardComplete() {
