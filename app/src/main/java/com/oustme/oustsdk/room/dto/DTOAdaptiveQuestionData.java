...
public class DTOAdaptiveQuestionData{
    ...
    private List<DTOAdaptiveCardDataModel> abstractCourseCardList;
    ...
    public DTOAdaptiveQuestionData() {
    }
    ...
    public List<DTOAdaptiveCardDataModel> getAbstractCourseCardList() {
        return abstractCourseCardList;
    }

    public void setAbstractCourseCardList(List<DTOAdaptiveCardDataModel> abstractCourseCardList) {
