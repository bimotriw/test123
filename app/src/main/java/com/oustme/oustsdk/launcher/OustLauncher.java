...
/**
 * This is OustLauncher class to launch oust
...
OustLauncher {
    ...
    private static final String TAG = "OustLauncher";

    private static OustLauncher oustLauncher = null;

    private OustLauncher() {
    }
    ...
    public static OustLauncher getInstance() {
        if (oustLauncher == null) {
            synchronized (OustLauncher.class) {
                if (oustLauncher == null)
                    oustLauncher = new OustLauncher();
            }
        }
        return oustLauncher;
    }
...
//        ResourceDownloadHandler handler = new ResourceDownloadHandler(activity);
//        handler.execute();
    }
...
//            registerRequestData.setOrgId(orgId);
    ...
    private void checkLayoutOpenLandingPage() {
        try {
            ...
            Log.e(TAG, "checkLayoutOpenLandingPage: -->" + e.getMessage());
            e.printStackTrace();
            OustSdkTools.sendSentryException(e);
        }
    }
