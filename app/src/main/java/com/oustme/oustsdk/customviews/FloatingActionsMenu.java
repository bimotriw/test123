...
public class FloatingActionsMenu extends ViewGroup {
  ...
  public void setmAddButtonColorNormal(int color){
    mAddButtonColorNormal=color;
    mAddButton.setColorNormal(color);
    invalidate();
  }

  public void setmAddButtonColorPressed(int color){
  ...
  private int getColor(@ColorRes int id) {
    return OustSdkTools.getColorBack(id);
  }
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    for (int i = 0; i < mButtonsCount; i++) {
      ...
      if((mExpandDirection==EXPAND_UP)||(mExpandDirection==EXPAND_DOWN)) {
        mMaxButtonWidth = Math.max(mMaxButtonWidth, child.getMeasuredWidth());
        height += child.getMeasuredHeight();
      } else if((mExpandDirection==EXPAND_LEFT)||(mExpandDirection==EXPAND_RIGHT)){
    ...
    if((mExpandDirection==EXPAND_UP)||(mExpandDirection==EXPAND_DOWN)) {
      ...
      else if((mExpandDirection==EXPAND_RIGHT)||(mExpandDirection==EXPAND_LEFT)){
