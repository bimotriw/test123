...
public class CustomRoundedImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mFillColor != Color.TRANSPARENT) {
            canvas.drawRoundRect(rect,mDrawableRadius,mDrawableRadius, mFillPaint);
        }
        canvas.drawRoundRect(rect,mDrawableRadius,mDrawableRadius, mBitmapPaint);
        if (mBorderWidth != 0) {
