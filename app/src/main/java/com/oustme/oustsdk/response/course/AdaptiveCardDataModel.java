...
@Keep
public class AdaptiveCardDataModel implements Comparable<AdaptiveCardDataModel>{
    ...
    private AdaptiveQuestionData questionData;
    ...
    public AdaptiveQuestionData getQuestionData() {
        return questionData;
    }

    public void setQuestionData(AdaptiveQuestionData questionData) {
    ...
    @Override
    public int compareTo(AdaptiveCardDataModel o) {
