...
package com.oustme.oustsdk.tools.charttools.animation;
...
public class ChartAnimator {
     ...
     * @param easing
     */
    public void animateY(int durationMillis, com.oustme.oustsdk.tools.charttools.animation.EasingFunction easing) {
