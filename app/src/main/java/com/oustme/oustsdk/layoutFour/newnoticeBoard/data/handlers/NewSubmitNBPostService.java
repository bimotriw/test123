...
public class NewSubmitNBPostService extends IntentService {
    ...
    private void checkForUpdates() {
        ...
        List<NewPostViewData> likePostDataList = RoomHelper.newGetTypeBasedPostViewData("like");

        List<NewPostViewData> commentPostDataList = RoomHelper.newGetTypeBasedPostViewData("comment");

        List<NewPostViewData> sharePostDataList = RoomHelper.newGetTypeBasedPostViewData("share_text");

        List<NewPostViewData> replyPostDataList = RoomHelper.newGetTypeBasedPostViewData("reply");

        List<NewPostViewData> deleteReplyPostDataList = RoomHelper.newGetTypeBasedPostViewData("delete_reply");

        List<NewPostViewData> deleteCommentPostDataList = RoomHelper.newGetTypeBasedPostViewData("delete_comment");
    ...
    private void deleteNBReplyData(final List<NewPostViewData> postDataList) {
        try {
                ...
                try {
                    ...
                    for (int i = 0; i < postDataList.size(); i++) {
                        ...
                        if (postDataList.get(i) != null) {
                            NewPostViewData postViewData = postDataList.get(i);
    ...
    private void deleteNBCommentData(final List<NewPostViewData> postDataList) {
        try {
    ...
    private void sendNBReplyData(final List<NewPostViewData> replyPostDataList) {
        try {
                ...
                try {
                    ...
                    for (int i = 0; i < replyPostDataList.size(); i++) {
                        ...
                        if (replyPostDataList.get(i) != null) {
                            NewPostViewData postViewData = replyPostDataList.get(i);
                            j.put("nbId", postViewData.getNbId());
                            j.put("postId", postViewData.getPostid());
                            j.put("commentId", postViewData.getNbReplyData().getCommentId());
                            j.put("timeStamp", postViewData.getTimeStamp());
    ...
    private void sendCommentData(final List<NewPostViewData> commentPostDataList) {
                ...
                try {
                    ...
                    for (int i = 0; i < commentPostDataList.size(); i++) {
                        ...
                        if (commentPostDataList.get(i) != null) {
                            NewPostViewData postViewData = commentPostDataList.get(i);
                            j.put("nbId", postViewData.getNbId());
                            j.put("postId", postViewData.getPostid());
                            j.put("comment", postViewData.getNbCommentData().getComment());
                            j.put("timestamp", postViewData.getTimeStamp());
                    ...
                    jsonObject.put("dataList", jsonArray);
                    Log.d("TAG", "new sendCommentData: "+jsonObject.toString());
    ...
    private void sendLikeData(final List<NewPostViewData> likePostDataList) {
        try {
                ...
                try {
                    ...
                    for (int i = 0; i < likePostDataList.size(); i++) {
                        ...
                        if (likePostDataList.get(i) != null) {
                            NewPostViewData postViewData = likePostDataList.get(i);
                            j.put("nbId", postViewData.getNbId());
                            j.put("postId", postViewData.getPostid());
    ...
    private void sendNBShareData(final List<NewPostViewData> sharePostDataList) {
                ...
                try {
                    ...
                    for (int i = 0; i < sharePostDataList.size(); i++) {
                        ...
                        if (sharePostDataList.get(i) != null) {
                            NewPostViewData postViewData = sharePostDataList.get(i);
                            j.put("nbId", postViewData.getNbId());
                            j.put("postId", postViewData.getPostid());
                            j.put("timestamp", postViewData.getTimeStamp());
                            jsonArray.put(j);
    ...
    public static void deletePostViewData(final List<NewPostViewData> postViewDataList) {
        try {
            List<NewPostViewData> nowData = new ArrayList<>();
