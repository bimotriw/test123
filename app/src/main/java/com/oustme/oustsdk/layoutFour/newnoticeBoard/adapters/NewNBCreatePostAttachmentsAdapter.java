...
public class NewNBCreatePostAttachmentsAdapter extends RecyclerView.Adapter<NewNBCreatePostAttachmentsAdapter.MyViewHolder> {
    ...
    public NewNBCreatePostAttachmentsAdapter(Context context, List<NewNBPostData.NewNBPostAttachmentsData> mNBPostAttachment, File imageFileName, List<Boolean> isAttachmentList, List<Bitmap> thumnai) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        try {
            NewNBPostData.NewNBPostAttachmentsData attachment = mNBPostAttachment.get(position);
            if (attachment != null) {
