...
public class NewNBPostData {
    ...
    private String title, description, createdBy, bannerBg, icon, tag, audio, video, assigneeRole, updatedBy, designation, userRole, avatar;
    long nbPostRewardOC;
    ...
    public List<NewNBCommentData> getNbCommentDataList() {
        return nbCommentDataList;
    }

    public void setNbCommentDataList(List<NewNBCommentData> nbCommentDataList) {
    ...
    public void initBaseData(Map<String, Object> lpMap) {
        try {
            ...
            this.avatar = OustSdkTools.convertToStr(lpMap.get("avatar"));
            ...
            this.designation = OustSdkTools.convertToStr(lpMap.get("designation"));
            this.userRole = OustSdkTools.convertToStr(lpMap.get("userRole"));
...
//                }
    ...
    public NewNBPostData incrementCommentCount() {
        this.commentedCount++;
        return this;
    }
    ...
    public void addOfflineComment(NewNBCommentData nbCommentData) {
    ...
    public class Attachment {
        ...
        public Attachment initData(Map<String, Object> lpMap) {
            ...
            if (lpMap.get("fileSize") != null) {
                this.fileSize = OustSdkTools.convertToLong(lpMap.get("fileSize").toString().replace("KB", ""));
