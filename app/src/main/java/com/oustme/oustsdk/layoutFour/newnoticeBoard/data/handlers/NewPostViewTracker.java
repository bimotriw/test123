...
public class NewPostViewTracker {
    ...
    public void setNbPostClickCallBack(NewNBPostClickCallBack nbPostClickCallBack) {
...
//                    recyclerView.getLayoutManager().findViewByPosition(i).getGlobalVisibleRect(rowRect);
                        Objects.requireNonNull(layoutManager.findViewByPosition(i)).getGlobalVisibleRect(rvRect);
                        int percentFirst;
                        if (rowRect.bottom >= rvRect.bottom) {
                            int visibleHeightFirst = rvRect.bottom - rowRect.top;
                            percentFirst = (visibleHeightFirst * 100) / Objects.requireNonNull(layoutManager.findViewByPosition(i)).getHeight();
                        } else {
