...
public class InAppAnalyticsSurveyAdapter extends RecyclerView.Adapter<InAppAnalyticsSurveyAdapter.ViewHolder> {

    Context context;
    String courses;
    ArrayList<InAppAnalyticsResponse.Surveys> surveysArrayList;
    int color;
    int bgColor;

    public InAppAnalyticsSurveyAdapter(InAppAnalyticsDetails inAppAnalyticsDetails, ArrayList<InAppAnalyticsResponse.Surveys> inAppAnalyticsResponse, String courses) {
        context = inAppAnalyticsDetails;
        this.surveysArrayList = inAppAnalyticsResponse;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        InAppAnalyticsResponse.Surveys inAppAnalyticsResponseIs = surveysArrayList.get(position);
        ...
        if (inAppAnalyticsResponseIs != null) {
            ...
            String previousDate;
            if (position > 0) {
                if (surveysArrayList.get(position - 1).getAssignedOn() != null && !surveysArrayList.get(position - 1).getAssignedOn().isEmpty()) {
                    Date endTsDatePrevious = new Date(Long.parseLong(surveysArrayList.get(position - 1).getAssignedOn()));
...
//                toolbarColorCode = "#f87800";
            ...
            name = inAppAnalyticsResponseIs.getSurveyName();
    ...
    private void workDiaryRedirection(InAppAnalyticsResponse.Surveys diaryDetailsModel) {

        BranchTools.gotoSurvey(diaryDetailsModel.getSurveyId(), 0);
